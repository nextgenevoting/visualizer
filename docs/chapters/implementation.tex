...
\captionof{figure}{From a high level perspective, оur application consists of 3 main components: The front-end (web-application), the back-end, and the crypto-library.}\label{System components}
\end{center}
\end{figure}
