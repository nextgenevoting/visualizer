...
\section{Use Cases}
As the next step, we have converted the requirements into use cases, by grouping them according to the actors. One use case is shown as an example. For the complete list of use cases we refer to the appendix.
