...
\begin{usecase}{Set-up an election event}
	...
	\addrow{Description}{The election administrator can set up the election. This involves the generation of the cryptographic electorate data in the back-end}
...
\begin{usecase}{Tallying}
	...
	\addrow{Postcondition}{The has the status "`Finished"'}
	\addmulrow{Main path (M)}{
