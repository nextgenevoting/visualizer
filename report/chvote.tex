...
Finally, within a \textbf{VoteSimulation}, all these entities are instantiated and perform their protocol steps in order. Example of the vote casting phase:
...
Based on the experience with Python that we have gathered throughout this project, we would not recommend to use Python for the use in similar project due to the reasons mentioned above. Python is indeed a very handy language to write quick prototypes and proof of concepts, but issues become more frequent in larger projects.
