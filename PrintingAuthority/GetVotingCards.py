...
from PrintingAuthority.GetVotingCard import GetVotingCard
from Utils.ToString             import ByteArrayToString

def GetVotingCards(v_bold, c_bold, n_bold, k_bold, E_bold, D_bold, secparams = secparams_default):
    """
    ...
    for i in range(len(E_bold)):
        ...
        s_bold.append(GetVotingCard(i, v_bold[i], c_bold, n_bold, k_i, X, Y, FC, rc_bold))
        rawSheetData.append(VotingSheet(i, v_bold[i], c_bold, n_bold, k_i, X, Y, FC, rc_bold))
