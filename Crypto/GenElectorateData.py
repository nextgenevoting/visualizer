...
def PartitionGenElectorateData(index, numOfProc, output, n, k,E, electionEvent, ctx = SECURITYCONTEXT_DEFAULT):
    """
    Algorithm 7.6: Generates the data for the whole electorate    
    ...
    if (electionEvent.N % numOfProc) != 0 and index == numOfProc-1:        
        partSize = partSize + electionEvent.N % numOfProc
